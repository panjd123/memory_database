...
__global__ void OLAPcore_rowwise(int8_t ** dimvec_array, int32_t ** fk_array, int * size_array,
                                 int * orders, int * dimvec_nums, int * factor,
                                 int * size_lineorder, int * group_nums,
                                 int32_t *M1, int32_t *M2, uint32_t * group_vector)
{
...
__global__ void OLAPcore_columnwise_dv(int8_t ** dimvec_array, int32_t ** fk_array, int * size_array,
                                       int * orders, int * dimvec_nums, int64_t * OID, int16_t * groupID,
                                       int * factor, int * size_lineorder, int * group_nums, int32_t * M1,
                                       int32_t * M2, uint32_t * group_vector)
{
...
__global__ void OLAPcore_vectorwise_dv(int8_t ** dimvec_array, int32_t ** fk_array, int * size_array,int * orders, int * dimvec_nums,
                                       int * factor, int * size_lineorder, int * group_nums, int32_t * M1,
                                       int32_t * M2, uint32_t * group_vector)
{
...
__global__ void OLAPcore_vectorwise_sv(int8_t ** dimvec_array, int32_t ** fk_array, int * size_array,
                                       int * orders, int * dimvec_nums,
                                       int * factor, int * size_lineorder, int * group_nums, int32_t * M1,
                                       int32_t * M2, uint32_t * group_vector)
{
    int64_t i = threadIdx.x;
...
__global__ void OLAPcore_vectorwise_sv_register(int8_t ** dimvec_array, int32_t ** fk_array, int * size_array,
                                       int * orders, int * dimvec_nums,
                                       int * factor, int * size_lineorder, int * group_nums, int32_t * M1,
                                       int32_t * M2, uint32_t * group_vector)
{
...
__global__ void OLAPcore_columnwise_sv(int8_t ** dimvec_array, int32_t ** fk_array, int * size_array,
                                       int * orders, int * dimvec_nums, int16_t * groupID,
                                       int * factor, int * size_lineorder, int * group_nums, int32_t * M1,
                                       int32_t * M2, uint32_t * group_vector)
{
    int64_t i = threadIdx.x + blockIdx.x * blockDim.x;
 ...
 * @return void 
 */
void test_OLAPcore_rowwise(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
...
void test_OLAPcore_cwm_dv(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
...
void test_OLAPcore_vwm_dv(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
...
void test_OLAPcore_vwm_sv(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
...
void test_OLAPcore_cwm_sv(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
...
void test_OLAPcore_columnwise(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
...
void test_OLAPcore_vectorwise(double SF, double* sele_array, int8_t **dimvec_array, int * bitmap_array, int32_t **fk_array, int * size_array, 
                           int32_t* M1, int32_t* M2, int* factor, int* d_orders, int * h_orders, int* d_dimvec_nums, int & h_dimvec_nums, int* d_group_nums, int & group_nums, int sqlnum, std::ofstream& timefile)
{
